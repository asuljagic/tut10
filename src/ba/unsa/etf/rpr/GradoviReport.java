...
public class GradoviReport extends JFrame {
    ...
    public void showReport(Connection conn) throws JRException {
        String reportSrcFile = getClass().getResource("/resources/reports/gradovi.jrxml").getFile();
        String reportsDir = getClass().getResource("/resources/reports/").getFile();
    ...
    public void showReportDrzava(Connection conn, String drzava) throws JRException {
        ...
        String reportSrcFile = getClass().getResource("/resources/reports/novi.jrxml").getFile();
        String reportsDir = getClass().getResource("/resources/reports/").getFile();
        JasperReport jasperReport = JasperCompileManager.compileReport(reportSrcFile);
    ...
    public void saveAs(String format, Connection conn, String filePath) throws JRException {
        ...
        switch (format) {
            ...
            default:
                System.out.println("Ekstenzija ne postoji!");
                break;
        }
    }
}
